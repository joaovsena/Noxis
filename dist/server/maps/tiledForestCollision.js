...
exports.getForestTiledCollisionSampler = getForestTiledCollisionSampler;
const fs_1 = require("fs");
const path_1 = __importDefault(require("path"));
const config_1 = require("../config");
const TMJ_PATH = path_1.default.resolve(process.cwd(), 'server', 'maps', 'map', 'a1.tmj');
const FLIPPED_GID_MASK = 0xe0000000;
const RAW_GID_MASK = 0x1fffffff;
let cachedSampler;
function getForestTiledCollisionSampler() {
...
function buildTilesetCollisionByFirstGid(tilesets) {
    const out = [];
    for (const tileset of tilesets) {
        ...
        if (!source)
            continue;
        const tsxPath = path_1.default.resolve(path_1.default.dirname(TMJ_PATH), source);
...
function parseCollisionTileIdsFromTsx(tsx) {
    const out = new Set();
...
//# sourceMappingURL=tiledForestCollision.js.map